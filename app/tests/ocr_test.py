...
class TestOCR(unittest.TestCase):
    ...
    def test_imagine7(self):
        img = cv2.imread("..\\app\\tests\\test_images\\test7.jpg")
        text = pt.image_to_string(img)
